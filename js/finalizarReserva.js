...
function getData(){
    ...
    infoMesa = sessionStorage.getItem("infoMesa");
    infoMesa = infoMesa.split(",");
    console.log(infoMesa);

    document.getElementById("dataReserva").innerHTML = infoMesa[1];
    document.getElementById("horaReserva").innerHTML = infoMesa[2];
    document.getElementById("pessoaReserva").innerHTML = infoMesa[3];
    document.getElementById("mesaReserva").innerHTML = infoMesa[4];
